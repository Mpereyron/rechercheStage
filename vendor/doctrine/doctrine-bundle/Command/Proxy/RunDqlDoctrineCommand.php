...
<info>php %command.full_name% "SELECT u FROM user-bundle:Model u"</info>

You can also optional specify some additional options like what type of
hydration to use when executing the query:

<info>php %command.full_name% "SELECT u FROM user-bundle:Model u" --hydrate=array</info>

Additionally you can specify the first result and maximum amount of results to
show:

<info>php %command.full_name% "SELECT u FROM user-bundle:Model u" --first-result=0 --max-result=30</info>
EOT
        );
    }
